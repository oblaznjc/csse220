...
public class StudentAssignmentsMain {
	 ...
	 * Program starts here.
	 * 
	 * @param args Ignore the args.
	 */
	public static void main(String[] args) {
		StudentAssignments one = new StudentAssignments("John Doe");
		StudentAssignments two = new StudentAssignments();
		 ...
		 * 
		 * Studenty McStudenton TwelveProblems - 80.0 WordGames - 78.0 Faces - 0.0
		 * 
		 * If you finish early, add a new function to compute the student's average and
		 * print it.
		 */
