...
public class RecursiveHelperFunctions {
	 ...
	 * 
	 * Both indexes are inclusive so sumArray(0,0,array) returns the first value of
	 * the array
	 * 
	 ...
	 * 
	 * Examples: {1,2,3,4} returns true {2,3,4} returns true {4,3} returns false {4}
	 * returns true
	 * 
	 * @param array
	 ...
	 * @return
	 */
	public boolean isOrderedHelper(int[] array) {
		return false;
	}
	 ...
	 * @return
	 */
	public boolean hasExactlyOneUppercaseHelper(String input) {
		return false;
	}
	...
	public static int longestChainLengthHelper(String input) {
		return 0;
	}
}
