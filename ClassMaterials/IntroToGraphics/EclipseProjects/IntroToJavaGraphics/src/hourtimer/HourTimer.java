 ...
 *
 * @author TODO <PUT_YOUR_NAME_HERE>. Created Dec 18, 2013.
 */
public class HourTimer {
	...
	public void drawOn(Graphics2D g) {
		...
		//no need to translate or rotate back to original, i.e. resets canvas
	...
	/**
	 * 
	 * Set time sets the position of the hand of the clock. 0/60 puts the hand
	 * facing upwards. 30 puts the hand facing downwards, etc.
	 * 
