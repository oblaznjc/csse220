 ...
 * Class: BankAccount
 * 
 * @author CSSE Faculty <br>
 *         Purpose: Used to hold account information (account name, balance)
 *         <br>
 *         Restrictions: Cannot be used for checking accounts <br>
 *         For example:
 * 
 *         <pre>
...
public class BankAccount {
	 ...
	 * initialBalance
	 * 
	 * @param accountName    used to initialize the account's name <br>
	 *                       requires: accountName &ne; ""
	 * @param initialBalance used to initialize the account's balance <br>
	 *                       requires: initialBalance &ge; 0.0
	 */
	 ...
	 * 
	 * @param depositAmount the amount to be added to the account's balance <br>
	 *                      requires: depositAmount &gt; 0.0
	 */
	 ...
	 * 
	 * @param newName the account's new name <br>
	 *                requires: newName &ne; ""
	 */
